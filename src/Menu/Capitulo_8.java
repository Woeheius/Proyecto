/**
 * Propósito: Clase que representa el capítulo que habla sobre la relación entre la educación y
 * la pobreza.
 *
 * Autores:
...
public final class Capitulo_8 extends JFrame {
    ...
    /**
     * Maneja el evento del botón "Capitulo_8" para abrir la ventana del
     * "Capítulo 8" y ocultar la ventana actual. (Nota: El nombre del método y
